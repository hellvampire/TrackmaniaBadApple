...
2. Frame generation with ffmpeg ```ffmpeg -i .\bad_apple_360x270.gif -vf "fps=1,scale=36:27" frame_%03d.png```
3. Generate ```bad_apple_greedy_placement.txt``` with ```bad_apple_compression.py```
